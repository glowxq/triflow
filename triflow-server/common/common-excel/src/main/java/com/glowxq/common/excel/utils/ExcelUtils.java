package com.glowxq.common.excel.utils;
...
import com.glowxq.common.excel.convert.CustomIntegerStringConvert;
import com.glowxq.common.excel.convert.CustomLongStringConvert;
import com.glowxq.common.excel.convert.CustomStringStringConvert;
import com.glowxq.common.excel.core.*;
...
public class ExcelUtils {
    ...
    public static <T> ExcelResult<T> importExcel(InputStream is, Class<T> clazz, boolean validateHeader) {
        ...
        ExcelListenerFactory listenerFactory = SpringUtils.getBean(ExcelListenerFactory.class);
