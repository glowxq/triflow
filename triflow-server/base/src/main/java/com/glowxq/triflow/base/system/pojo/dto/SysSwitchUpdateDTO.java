 ...
 */
@Data
@Schema(description = "系统开关更新请求")
@AutoMapper(target = SysSwitch.class)
public class SysSwitchUpdateDTO implements BaseDTO {

    /** 开关ID */
    @Schema(description = "开关ID", example = "1", requiredMode = Schema.RequiredMode.REQUIRED)
